...
#include "RaydriveC1OffroadCar.h"
#include "RaydriveC1OffroadWheelFront.h"
#include "RaydriveC1OffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ARaydriveC1OffroadCar::ARaydriveC1OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URaydriveC1OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URaydriveC1OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URaydriveC1OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URaydriveC1OffroadWheelRear::StaticClass();
